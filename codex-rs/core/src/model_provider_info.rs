...
pub struct ModelProviderInfo {
    ...
    /// Does this provider require Oracle Code Assist auth? If true, the forced login method is
    /// set to OCA and the user is taken through the login process on load
    #[serde(default)]
    pub requires_oracle_code_assist_auth: bool,
}
...
pub fn create_oca_provider() -> ModelProviderInfo {
    ModelProviderInfo {
        ...
        base_url: std::env::var("CODEX_CLI_OCA_BASE_URL")
            ...
            .or_else(|| Some(OCA_DEFAULT_BASE_URL.to_string())),
        env_key: None,
        ...
        http_headers: Some(
            [
                ...
                ("client-version".to_string(), "1".to_string()),
            ]
            .into_iter()
            .collect(),
        ),
